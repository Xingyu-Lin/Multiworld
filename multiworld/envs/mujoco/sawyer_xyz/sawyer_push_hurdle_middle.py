...
class SawyerPushAndReachHurdleMiddleXYEnv(MujocoEnv, Serializable, MultitaskEnv):
    INIT_HAND_POS = np.array([-0.1, 0.5, 0.02])
    ...
    def model_name(self):
        return get_asset_full_path(
            'sawyer_xyz/sawyer_push_and_reach_mocap_goal_hidden_hurdle_middle.xml'
        )
...
class SawyerPushAndReachHurdleMiddleXYEasyEnv(SawyerPushAndReachHurdleMiddleXYEnv):
    """
    ...
    def __init__(
        ...
        SawyerPushAndReachHurdleMiddleXYEnv.__init__(
            self,
            **actual_kwargs
        )
...
class SawyerPushAndReachHurdleMiddleXYHarderEnv(SawyerPushAndReachHurdleMiddleXYEnv):
    """
