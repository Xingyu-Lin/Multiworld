...
class SawyerPushAndReachHurdleXYEnv(MujocoEnv, Serializable, MultitaskEnv):
    ...
    def model_name(self):
        return get_asset_full_path(
            'sawyer_xyz/sawyer_push_and_reach_mocap_goal_hidden_hurdle.xml'
        )
...
class SawyerPushAndReachHurdleXYEasyEnv(SawyerPushAndReachHurdleXYEnv):
    """
    ...
    def __init__(
        ...
        SawyerPushAndReachHurdleXYEnv.__init__(
            self,
            **actual_kwargs
        )
